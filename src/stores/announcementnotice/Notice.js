...
export default class Notice{
  ...
  @observable DataListColumn=[
    {type: 'string', id: 'pk_notice', label: '主键', hidden: true},
    {type: 'string', id: 'title', label: '通知标题'},
    {type: 'string', id: 'author', label: '通知发布者'},
